...
const CreatePostingans = () => {
  ...
  const postData = (e) => {
    e.preventDefault();
    axios.post("https://67b731f22bddacfb270e0dda.mockapi.io/users", {
      judul,
      deskripsi,
      kategori,
      harga,
  ...
  return (
    <>
      <section className="w-full items-center justify-center h-[100vh] flex flex-row">
        <img
          src="./images/cp1.png"
          className="w-[50%] h-[50vh] object-cover"
        />
        <div className="flex items-center justify-center w-full">
          <form
            ...
            onSubmit={postData}
          >
            <h2 className="text-4xl font-bold text-black">Buat Kelas</h2>
